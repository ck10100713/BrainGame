...
import { BrainCircuit, CircleDot, ArrowRight, Hexagon } from 'lucide-react';
...
const MainMenu: React.FC<MainMenuProps> = ({ onSelectGame }) => {
  return (
    <div className="w-full max-w-6xl flex flex-col items-center gap-12 animate-in fade-in duration-700 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
        ...
        >
          ...
          <div className="mt-auto p-6 z-10 space-y-2">
            <h3 className="text-2xl font-display font-bold text-white group-hover:text-blue-200 transition-colors">
              SphereShift
            </h3>
            <p className="text-slate-400 text-sm leading-relaxed">
        ...
        >
          ...
          <div className="mt-auto p-6 z-10 space-y-2">
            <h3 className="text-2xl font-display font-bold text-white group-hover:text-pink-200 transition-colors">
              HexLogic
            </h3>
            <p className="text-slate-400 text-sm leading-relaxed">
              Complex geometry challenge. Click intersections to rotate hexagonal clusters of triangles.
            </p>
          </div>
