...
struct SpinMatrixLogic {
    /// Creates a solved grid pattern (Quadrants)
    /// Top-Left: Red, Top-Right: Yellow
    /// Bottom-Left: Blue, Bottom-Right: Green
    static func createTargetGrid(size: Int) -> SpinMatrixGridState {
        var grid: SpinMatrixGridState = []
        let mid = size / 2
    ...
    static func copyGrid(_ grid: SpinMatrixGridState) -> SpinMatrixGridState {
        return grid.map { $0 }
    }
    ...
    static func rotateSubgrid(_ grid: SpinMatrixGridState, row: Int, col: Int) -> SpinMatrixGridState {
    ...
    static func scrambleGrid(_ grid: SpinMatrixGridState, size: Int, moves: Int = 20) -> SpinMatrixGridState {
    ...
    static func checkWin(gridA: SpinMatrixGridState, gridB: SpinMatrixGridState) -> Bool {
